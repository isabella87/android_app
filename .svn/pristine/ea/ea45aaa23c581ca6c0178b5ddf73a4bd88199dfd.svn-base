...
public class Constants {
	...
	public static final String accsrvUrl = "https://www.banbank.com/accsrv/";
	public static final String p2psrvUrl = "https://www.banbank.com/p2psrv/";
	public static final String mobileUrl = "https://www.banbank.com/m/";
	
	/*public static final String url = "192.168.11.30";
	public static final String accsrvUrl = "http://192.168.11.30/accsrv/";
	public static final String p2psrvUrl = "http://192.168.11.30/p2psrv/";
	public static final String mobileUrl = "http://192.168.11.30/m/";*/
	
	/*public static final String url = "192.168.11.190";
	public static final String accsrvUrl = "http://192.168.11.190:8889/accsrv/";
	public static final String p2psrvUrl = "http://192.168.11.190:8889/p2psrv/";
	public static final String mobileUrl = "http://192.168.11.190:8889/m/";*/
	...
	public static String IS_NOT_FIRST_IN = "Y";
	...
	public static final String CONTROL_COOKIE = "CONTROL_COOKIE";
	
	public static final int COLOR_DARK_GREY = Color.rgb(0x66, 0x66, 0x66);
	public static final int COLOR_GREY = Color.rgb(0xAD, 0xAD, 0xAD);
	public static final int COLOR_DARK_GREEN = Color.rgb(0x00, 0x64, 0x00);
	public static final int COLOR_GREEN = Color.rgb(0x00, 0xCD, 0x66);
	public static final int COLOR_SLATE_BLUE = Color.rgb(0x6A, 0x5A, 0xCD);
	public static final int COLOR_FIREBRICK = Color.rgb(0xB2, 0x22, 0x22);
	public static final int COLOR_MEDIUM_AQUAMARINE = Color.rgb(0x66, 0xCD, 0xAA);
	public static final int COLOR_YELLOW = Color.rgb(0xFF, 0xFF, 0x00);
	public static final int COLOR_RED = Color.rgb(0xFF, 0x00, 0x00);
	public static final int COLOR_LIGHT_SEA_GREEN = Color.rgb(0x20, 0xB2, 0xAA);
}
