	...
	private void initListener() {
		...
		wvEntDetails.setDownloadListener(new DownloadListener(){
			...
			public void onDownloadStart(String url, String userAgent,
				...
				System.out.println("*System.out.println:*start {url=" + url + ",content-disposition=" + contentDisposition + "mime-type=" + mimetype + "}");
				// 方法三：指定下载地址
...
//		        request.setDestinationInExternalFilesDir()
		        ...
		        System.out.println("*System.out.println:*enqueue {id=" + downloadId + "}");
			}
...
//            log.verbose("onReceive. intent:{}", intent != null ? intent.toUri(0) : null);
            if (intent != null) {
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.getAction())) {
                    ...
                    System.out.println("downloaded to " + uri + ", type=" + mimetype);
                    if (uri != null) {
