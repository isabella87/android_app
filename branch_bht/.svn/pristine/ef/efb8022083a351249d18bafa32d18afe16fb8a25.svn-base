...
public class IndexStrategyActivity extends BaseActivity {
	...
	private void setListener() {
		...
		imgBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				IndexStrategyActivity.this.finish();
			}
		});
...
//				handler.cancel(); //默认的处理方式，WebView变成空白页
	...
	private void show(){
		...
		String url = Constants.mobileUrl + "app/info-list.html?type=7";
		String cookieString = "";
