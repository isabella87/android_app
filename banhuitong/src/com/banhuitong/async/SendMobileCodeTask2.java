...
public class SendMobileCodeTask2 implements Runnable {
	
	private static final String TAG = "SendMobileCodeTask2" ;  
	private Handler handler;
	private String mobile;
	
	public SendMobileCodeTask2(Handler handler, String mobile) {
		super();
	...
	@Override  
    public void run() {  
//		String path = Constants.serverUrlp2p + "account/send-mobile-assign-code";
		String path = Urls.URL_29;
