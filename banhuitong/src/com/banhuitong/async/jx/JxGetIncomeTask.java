    ...
    public void run() {
		...
		try {
			...
			for(int i = 0; i < jsonArray.length() ; i++){ 
				...
				accIncome.put("amount", BigDecimal.valueOf(jsonObj.optDouble("amount",0)));
				accIncome.put("desc", (jsonObj.getString("desc")));
				accIncome.put("last-nx-reld", (jsonObj.optString("hsReld")));
				accIncome.put("last-nx-trnn", (jsonObj.optString("trxNo")));
