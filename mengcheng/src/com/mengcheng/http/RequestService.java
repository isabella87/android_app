...
import com.mengcheng.activity.BaseActivity;
...
public class RequestService {
	...
	// System.loadLibrary("RequestServiceJni");
	// }
	...
	public String getRequest(List<BasicNameValuePair> params, String url,
		...
		System.out.println(cookieStore.toString()+"sssss");
		...
		if (response.getStatusLine().getStatusCode() == OK) {
				...
				for (int i = cookies.size(); i > 0; i--) {
					...
					if (cookie.getName().equalsIgnoreCase(Constants.__AUTH__)) {
						...
						if (MyApplication.sp != null) {
							...
							ed.putString(Constants.SAVED_COOKIE, cookieString);
							ed.commit();*/
						}
					}
			...
			Log.i(TAG, "response:" + responseEntity);
