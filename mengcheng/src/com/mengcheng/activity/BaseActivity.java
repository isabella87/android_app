...
import com.mengcheng.async.GetCryptMobileTask;
import com.mengcheng.http.RequestService;
import com.mengcheng.receiver.SystemReceiver;
...
//	}
	 ...
	 * 分享数据准备
	 */
	protected void share(String rcode) {
		DefaultThreadPool.getInstance().execute(new GetCryptMobileTask(baseHandler,rcode));
	}
	/**
	 * 
	 * 分享
	...
	public void showShare(String rcodeUrl) {
		...
		/* String shareUrl = null;
		 String path = Urls.URL_15;
			...
			shareUrl = shareUrl.substring(1,shareUrl.length()-1);*/
