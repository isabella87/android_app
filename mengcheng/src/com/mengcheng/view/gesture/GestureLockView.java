package com.mengcheng.view.gesture;
...
public class GestureLockView extends View {
	 ...
	 */
	enum Mode {
		STATUS_NO_FINGER, STATUS_FINGER_ON, STATUS_FINGER_UP, STATUS_FINGER_UP_WRONG;
	}
	...
	public GestureLockView(Context context, int colorNoFingerInner,
			int colorNoFingerOutter, int colorFingerOn, int colorFingerUp, int colorFingerUpWrong) {
		super(context);
